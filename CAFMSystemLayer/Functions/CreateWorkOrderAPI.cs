...
namespace CAFMSystemLayer.Functions
{
    public class CreateWorkOrderAPI
    {
        ...
        public CreateWorkOrderAPI(ILogger<CreateWorkOrderAPI> logger, IWorkOrderMgmt workOrderMgmt)
        {
            _logger = logger;
        ...
        public async Task<BaseResponseDTO> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "cafm/workorder/create")] HttpRequest req,
