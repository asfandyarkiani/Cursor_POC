...
namespace OracleFusionHCM.LeaveManagement.ConfigModels
{
    public class AppConfigs : IConfigValidator
    {
        ...
        public string LeaveResourcePath { get; set; } = string.Empty;
        ...
        public void validate()
        {
            ...
            if (string.IsNullOrWhiteSpace(LeaveResourcePath))
                errors.Add("LeaveResourcePath is required");
