...
namespace SysNetworkMgmt.Implementations.Network.Services
{
    ...
    /// Delegates business operations to handlers.
    /// </summary>
    public class NetworkMgmtService : INetworkMgmt
    {
        ...
        /// <summary>
        /// Initializes a new instance of the NetworkMgmtService class.
        /// </summary>
        /// <param name="logger">The logger instance.</param>
        /// <param name="networkTestHandler">The network test handler.</param>
