namespace CAFMSystem.Constants
{
    public class InfoConstants
    {
        ...
        public const string GET_INSTRUCTION_SET_SUCCESS = "Instruction set details retrieved successfully from CAFM system.";
        public const string GET_BREAKDOWN_TASK_SUCCESS = "Breakdown task details retrieved successfully from CAFM system.";
        public const string CREATE_BREAKDOWN_TASK_SUCCESS = "Breakdown task created successfully in CAFM system.";
        public const string CREATE_EVENT_SUCCESS = "Event created and linked successfully in CAFM system.";
